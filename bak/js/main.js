document.addEventListener("DOMContentLoaded", () => {
    ...
    class Point {
        constructor(name = "undefined", lat = ((Math.random() * 50) + 40), lng = ((Math.random() * 100) + 100), zoom = 4.5) {
            this.name = name;
            this.lat = lat;
            this.lng = lng;
            this.zoom = zoom;
        ...
        goTo() {
            ...
            mapInit.setView({ lat: this.lat, lng: this.lng }, this.zoom);
        }
    ...
    new Point("Ontario", 65.5129625532949, 221.66015625);
    new Point("Bench", 63, 190,7);
    new Point("Random");
