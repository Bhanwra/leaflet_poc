    ...
    render() {
        ...
        return (
            <div className='mt-0 md:mt-10'>
                ...
                <a className={`my-2 inline-block p-2 tracking-widest uppercase rounded-lg text-sm transition-all shadow-lg bg-theme-grey-100`} onClick={() => { this.toggleSearch() }}>Go To</a>

                {/* GO TO PANEL */}
                <section className={`rounded-2xl mb-3 bg-theme-grey-50 overflow-hidden shadow-lg transition-all ${this.state.searchHidden ? 'max-h-0' : 'max-h-32'}`}>
